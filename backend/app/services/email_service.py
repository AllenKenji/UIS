...
def _template(email_type: str, full_name: str, reset_link: str | None = None) -> tuple[str, str]:
...
def send_email(email_type: str, recipient: str, full_name: str, reset_link: str | None = None) -> None:
    subject, text = _template(email_type, full_name, reset_link)
