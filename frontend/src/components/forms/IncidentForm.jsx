...
const IncidentForm = ({ role = "resident", userInfo, residentProfile, onSubmitSuccess }) => {
  const { userInfo: sessionUser } = useUser();
  const activeUser = residentProfile
    ? { uid: residentProfile.residentId, fullName: residentProfile.fullName }
  ...
  const initialForm = {
    ...
    residentId: role === "resident" ? activeUser?.uid || "" : "",
  };
