...
import PublicIncidentReport from "../pages/public/PublicIncidentReport";
...
const AppRoutes = ({ isDarkMode, toggleDarkMode }) => {
  ...
  const isPublicRoute =
    ["/login", "/reset-password", "/unauthorized", "/payment-success", "/payment-cancel"].includes(location.pathname) ||
    location.pathname === "/" ||
      ...
      <main>
        <Routes>
          ...
          <Route element={<PublicLayout />}>
            ...
            <Route path="/b/:barangayId/public-services/documents/new" element={<PublicDocumentRequest />} />
            <Route path="/b/:barangayId/public-services/businesses/new" element={<PublicBusinessRegistration />} />
            <Route path="/b/:barangayId/public-services/complaints/new" element={<PublicComplaintForm />} />
            <Route path="/b/:barangayId/public-services/incidents/new" element={<PublicIncidentReport />} />
          </Route>
          ...
          >
            ...
            <Route path="/accounts/new" element={<ProtectedRoute allowedRoles={["admin", "super_admin"]}><CreateAccountForm /></ProtectedRoute>} />
            ...
            />
            <Route path="/messages" element={<ProtectedRoute allowedRoles={["admin", "staff", "resident", "secretary", "treasurer", "sk", "dilg", "surveyor", "supervisor"]} allowAdminOverride={false}><MessagesPage /></ProtectedRoute>} />
            <Route path="/my-signature" element={<ProtectedRoute allowedRoles={["admin", "staff", "secretary", "treasurer", "sk"]} allowAdminOverride={false}><MySignaturePage /></ProtectedRoute>} />
